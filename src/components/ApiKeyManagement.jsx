...
const ApiKeyManagement = ({ user }) => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg">How to Use API Keys</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="space-y-4 text-sm">
            <div>
              <h4 className="font-medium mb-2">Authentication</h4>
              <p className="text-gray-600 mb-2">Include your API key in requests using one of these methods:</p>
              <div className="bg-gray-100 p-3 rounded font-mono text-xs space-y-1">
                <div>Header: <span className="text-blue-600">X-API-Key: your_api_key_here</span></div>
                <div>Authorization: <span className="text-blue-600">Bearer your_api_key_here</span></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="bg-gray-100 p-3 rounded font-mono text-xs">
                <div className="text-gray-600"># Test your API key</div>
                <div>curl -H "X-API-Key: your_api_key_here" \</div>
                <div className="ml-4">{window.location.origin}/api/api-keys/test</div>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-gray-600 space-y-1">
                ...
                <li><strong>Write:</strong> Create sessions, submit votes, invite users</li>
